...
class _MyHomePageState extends State<MyHomePage> with TickerProviderStateMixin{
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text("Hello, Jenson.", style: TextStyle(fontSize: 30.0, color: Colors.white, fontWeight: FontWeight.w400),),
                    ),
            ...
            Column(
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: Text("TODAY : $_timeString", style: TextStyle(color: Colors.white),),
                ),
                Container(
                  height: 350.0,
  ...
  String _formatDateTime(DateTime dateTime) {
    return DateFormat('EEEE, dd MMM yyyy hh:mm:ss a').format(dateTime);
  }
}
